        ...
        try {
            ...
            if (!ftp.changeWorkingDirectory(basePath + filePath)) {
                ...
                for (String dir : dirs) {
                    ...
                    tempPathBuilder.append("/");
                    tempPathBuilder.append(dir);
                    if (!ftp.changeWorkingDirectory(tempPathBuilder.toString())) {
                        if (!ftp.makeDirectory(tempPathBuilder.toString())) {
                            return result;
                        } else {
                            ftp.changeWorkingDirectory(tempPathBuilder.toString());
                        }
                    }
                }
            }
